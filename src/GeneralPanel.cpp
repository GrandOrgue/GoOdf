...
GeneralPanel::GeneralPanel(wxWindow *parent) : wxScrolledWindow(parent) {
	...
	seventhRow2ndCol->Add(m_addReferencedDivisionalCoupler, 0, wxGROW|wxALIGN_CENTER|wxALL, 5);
	m_addAllAvailableDivisionalCouplers = new wxButton(
		this,
		ID_GENERAL_ADD_ALL_DIV_CPLRS_BTN,
		wxT("Add all")
	);
	seventhRow2ndCol->Add(m_addAllAvailableDivisionalCouplers, 0, wxGROW|wxALIGN_CENTER|wxALL, 5);
	m_removeReferencedDivisionalCoupler = new wxButton(
		this,
		ID_GENERAL_REMOVE_DIV_CPLR_BTN,
		wxT("<- Remove")
	);
	seventhRow2ndCol->Add(m_removeReferencedDivisionalCoupler, 0, wxGROW|wxALIGN_CENTER|wxALL, 5);
	seventhRow2ndCol->AddStretchSpacer();
	...
	seventhRow4thCol->Add(divOnOffText, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);
